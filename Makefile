...
# Test
#
TEST_FILE = local/2020-01-issue/master.md
EXTRA_METADATA = local/settings/collection.yaml

test: $(BUILT_FILE) $(TEST_FILE) $(EXTRA_METADATA)
	@pandoc lua dialoa2json.lua \
		$(TEST_FILE) --metadata-file $(EXTRA_METADATA)